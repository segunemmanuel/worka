        ...
        <div class="container">
                             ...
                             <div id="mc_embed_signup">
                                 ...
                                 method="get" class="relative subscribe_form mail_part">
                                     ...
                                     <div class="form-icon">
                                         ...
                                         class="email_icon newsletter-submit button-contactForm"><img src="files/img/icon/form.png" alt=""></button>
                                     </div>
           ...
           <div class="row footer-wejed justify-content-between">
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                    ...
                    <a href="index.html"><img src="files/img/logo/logo2_footer.png" alt=""></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
...
<script src="{{asset('./files/js/vendor/modernizr-3.5.0.min.js')}}"></script>
<!-- Jquery, Popper, Bootstrap -->
<script src="{{asset('./files/js/vendor/jquery-1.12.4.min.js')}}"></script>
<script src="{{asset('./files/js/popper.min.js')}}"></script>
<script src="{{asset('./files/js/bootstrap.min.js')}}"></script>
<!-- Jquery Mobile Menu -->
<script src="{{asset('./files/js/jquery.slicknav.min.js')}}"></script>

<!-- Jquery Slick , Owl-Carousel Plugins -->
<script src="{{asset('./files/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('./files/js/slick.min.js')}}"></script>
<script src="{{asset('./files/js/price_rangs.js')}}"></script>

<!-- One Page, Animated-HeadLin -->
<script src="{{asset('./files/js/wow.min.js')}}"></script>
<script src="{{asset('./files/js/animated.headline.js')}}"></script>
<script src="{{asset('./files/js/jquery.magnific-popup.js')}}"></script>

<!-- Scrollup, nice-select, sticky -->
<script src="{{asset('./files/js/jquery.scrollUp.min.js')}}"></script>
<script src="{{asset('./files/js/jquery.nice-select.min.js')}}"></script>
<script src="{{asset('./files/js/jquery.sticky.js')}}"></script>

<!-- contact js -->
<script src="{{asset('./files/js/contact.js')}}"></script>
<script src="{{asset('./files/js/jquery.form.js')}}"></script>
<script src="{{asset('./files/js/jquery.validate.min.js')}}"></script>
<script src="{{asset('./files/js/mail-script.js')}}"></script>
